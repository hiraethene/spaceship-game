...
public class Main {
    public static void main(String[] args) {
       ...
       // ship.Dock(base);
        ...
        //Note, all starships should have the following default values:
        //• Maximum Crew: 10
        //• Maximum Health: 100
        //• Maximum Attack Strength: 30
        //• Maximum Defence Strength: 10
        //And all starbases should have the following values
        //• Maximum health: 500
        //• Maximum defence: 20
